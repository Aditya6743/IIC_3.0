...
def process_logo_full(input_path, output_path):
    ...
    # Apply alpha matting to EVERY pixel in the image
    for y in range(height):
        for x in range(width):
            ...
            if r > 245 and g > 245 and b > 245:
                ...
                # Black text (R=10) will have high alpha (245/255 -> 0.96)
                # Cyan (R=12) will have high alpha
                # White (R=255) will have alpha 0
    ...
    print(f"Successfully applied full matting and saved to {output_path}")
